...
const description = `This is an AI driven text based adventure game, where you explore an alien world and make choices that will affect the outcome of the story. 

All content in this game was generated by AI.`;

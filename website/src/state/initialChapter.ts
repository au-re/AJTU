...
export const initialChapter: Chapter = {
  ...
  text: `Chased by bounty hunters you have been hurtling through the vast expanse of space in a sleek, state-of-the-art spaceship when disaster struck. 
An unexpected gravitational anomaly sent the vessel spiraling out of control, and before you could react, the ship careened into the atmosphere of an unknown planet. 
The impact was jarring, and you were tossed around the cockpit like a rag doll, dazed and disoriented.
For a moment, everything was a blur of flashing lights and deafening alarms, but as the smoke cleared, you realized that the ship had crash-landed in the midst of a dense, jungle-like terrain. 
